...
<script>
import { listMember, getMember, delMember, addMember, updateMember } from "@/api/tech/member"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('tech/member/export', {
        ...this.queryParams
