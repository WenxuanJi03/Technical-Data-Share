<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['tech:workshop:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['tech:workshop:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="workshopList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="负责人ID" align="center" prop="leaderId" />
...
<script>
import { listWorkshop, getWorkshop, delWorkshop, addWorkshop, updateWorkshop } from "@/api/tech/workshop"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('tech/workshop/export', {
        ...this.queryParams
